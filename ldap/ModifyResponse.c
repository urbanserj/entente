...
int ModifyResponse_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void ModifyResponse_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td)
{
...
void ModifyResponse_free(asn_TYPE_descriptor_t *td, void *struct_ptr,
                         int contents_only)
{
...
int ModifyResponse_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t ModifyResponse_decode_ber(asn_codec_ctx_t *opt_codec_ctx,
...
asn_enc_rval_t ModifyResponse_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t ModifyResponse_decode_xer(asn_codec_ctx_t *opt_codec_ctx,
                                         asn_TYPE_descriptor_t *td,
                                         void **structure,
...
asn_enc_rval_t ModifyResponse_encode_xer(asn_TYPE_descriptor_t *td,
...
static const ber_tlv_tag_t asn_DEF_ModifyResponse_tags_1[] = {
    (ASN_TAG_CLASS_APPLICATION | (7 << 2)),
    (ASN_TAG_CLASS_UNIVERSAL | (16 << 2))};
asn_TYPE_descriptor_t asn_DEF_ModifyResponse = {
    "ModifyResponse", "ModifyResponse", ModifyResponse_free,
    ModifyResponse_print, ModifyResponse_constraint, ModifyResponse_decode_ber,
    ModifyResponse_encode_der, ModifyResponse_decode_xer,
    ModifyResponse_encode_xer, 0,
    0, /* No PER support, use "-gen-PER" to enable */
    0, /* Use generic outmost tag fetcher */
    asn_DEF_ModifyResponse_tags_1,
    sizeof(asn_DEF_ModifyResponse_tags_1) /
            sizeof(asn_DEF_ModifyResponse_tags_1[0]) -
        1,                         /* 1 */
    asn_DEF_ModifyResponse_tags_1, /* Same as above */
    sizeof(asn_DEF_ModifyResponse_tags_1) /
        sizeof(asn_DEF_ModifyResponse_tags_1[0]), /* 2 */
