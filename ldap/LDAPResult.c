...
static asn_TYPE_member_t asn_MBR_LDAPResult_1[] = {
    {ATF_NOFLAGS, 0, offsetof(struct LDAPResult, resultCode),
     (ASN_TAG_CLASS_UNIVERSAL | (10 << 2)), 0, &asn_DEF_resultCode_2,
     0, /* Defer constraints checking to the member type */
     0, /* PER is not compiled, use -gen-PER */
     0, "resultCode"},
    {ATF_NOFLAGS, 0, offsetof(struct LDAPResult, matchedDN),
     (ASN_TAG_CLASS_UNIVERSAL | (4 << 2)), 0, &asn_DEF_LDAPDN,
     0, /* Defer constraints checking to the member type */
     0, /* PER is not compiled, use -gen-PER */
     0, "matchedDN"},
    {ATF_NOFLAGS, 0, offsetof(struct LDAPResult, diagnosticMessage),
     (ASN_TAG_CLASS_UNIVERSAL | (4 << 2)), 0, &asn_DEF_LDAPString,
     0, /* Defer constraints checking to the member type */
     0, /* PER is not compiled, use -gen-PER */
     0, "diagnosticMessage"},
    {ATF_POINTER, 1, offsetof(struct LDAPResult, referral),
...
static const ber_tlv_tag_t asn_DEF_LDAPResult_tags_1[] = {
    (ASN_TAG_CLASS_UNIVERSAL | (16 << 2))};
static const asn_TYPE_tag2member_t asn_MAP_LDAPResult_tag2el_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_LDAPResult_specs_1 = {
    sizeof(struct LDAPResult),   offsetof(struct LDAPResult, _asn_ctx),
    asn_MAP_LDAPResult_tag2el_1, 4, /* Count of tags in the map */
    0,                           0,
    0, /* Optional elements (not needed) */
    3, /* Start extensions */
    5  /* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_LDAPResult = {
    "LDAPResult", "LDAPResult", SEQUENCE_free, SEQUENCE_print,
    SEQUENCE_constraint, SEQUENCE_decode_ber, SEQUENCE_encode_der,
    SEQUENCE_decode_xer, SEQUENCE_encode_xer, 0,
    0, /* No PER support, use "-gen-PER" to enable */
    0, /* Use generic outmost tag fetcher */
    asn_DEF_LDAPResult_tags_1, sizeof(asn_DEF_LDAPResult_tags_1) /
                                   sizeof(asn_DEF_LDAPResult_tags_1[0]), /* 1 */
    asn_DEF_LDAPResult_tags_1, /* Same as above */
    sizeof(asn_DEF_LDAPResult_tags_1) /
        sizeof(asn_DEF_LDAPResult_tags_1[0]), /* 1 */
    0,                                        /* No PER visible constraints */
    asn_MBR_LDAPResult_1,
    4,                          /* Elements count */
    &asn_SPC_LDAPResult_specs_1 /* Additional specs */
};
