...
static asn_TYPE_member_t asn_MBR_AttributeList_1[] = {
    {ATF_POINTER, 0, 0, (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 0,
     &asn_DEF_Attribute, 0, /* Defer constraints checking to the member type */
     0,                     /* PER is not compiled, use -gen-PER */
     0, "attribute"},
};
static const ber_tlv_tag_t asn_DEF_AttributeList_tags_1[] = {
    (ASN_TAG_CLASS_UNIVERSAL | (16 << 2))};
static asn_SET_OF_specifics_t asn_SPC_AttributeList_specs_1 = {
    sizeof(struct AttributeList), offsetof(struct AttributeList, _asn_ctx),
    0, /* XER encoding is XMLDelimitedItemList */
};
asn_TYPE_descriptor_t asn_DEF_AttributeList = {
    "AttributeList", "AttributeList", SEQUENCE_OF_free, SEQUENCE_OF_print,
