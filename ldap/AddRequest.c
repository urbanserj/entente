...
static asn_TYPE_member_t asn_MBR_AddRequest_1[] = {
    ...
    {ATF_NOFLAGS, 0, offsetof(struct AddRequest, attributes),
     (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 0, &asn_DEF_AttributeList,
     0, /* Defer constraints checking to the member type */
     0, /* PER is not compiled, use -gen-PER */
     0, "attributes"},
};
static const ber_tlv_tag_t asn_DEF_AddRequest_tags_1[] = {
    (ASN_TAG_CLASS_APPLICATION | (8 << 2)),
    (ASN_TAG_CLASS_UNIVERSAL | (16 << 2))};
static const asn_TYPE_tag2member_t asn_MAP_AddRequest_tag2el_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_AddRequest_specs_1 = {
    sizeof(struct AddRequest),   offsetof(struct AddRequest, _asn_ctx),
    asn_MAP_AddRequest_tag2el_1, 2, /* Count of tags in the map */
    0,                           0,
...
asn_TYPE_descriptor_t asn_DEF_AddRequest = {
    "AddRequest", "AddRequest", SEQUENCE_free, SEQUENCE_print,
    ...
    sizeof(asn_DEF_AddRequest_tags_1) / sizeof(asn_DEF_AddRequest_tags_1[0]) -
        1,                     /* 1 */
