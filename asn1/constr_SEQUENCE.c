    ...
    case 1:
        ...
        for (edx = (ctx->step >> 1); edx < td->elements_count;
            ...
            if (ctx->left == 0 /* No more stuff is expected */
                && (
                       /* Explicit OPTIONAL specification reaches the
                          end */
            ...
            if (ctx->left < 0 && ((const uint8_t *)ptr)[0] == 0) {
                if (LEFT < 2) {
                    ...
                    ASN_DEBUG("edx = %d, opt = %d, ec=%d", edx,
                              elements[edx].optional, td->elements_count);
            ...
            if (use_bsearch) {
                ...
                if (t2m) {
                     ...
                     * tag,
                     * `cause bsearch() does not guarantee
                     * order.
                     */
                                   ...
                                   size_t size)
{
    ...
    for (edx = ctx->step; ctx->phase <= 3;) {
        ...
        case XCT_UNKNOWN_BO:
            ...
            ASN_DEBUG("XER/SEQUENCE: tcv=%d, ph=%d, edx=%d", tcv, ctx->phase,
                      edx);
            if (ctx->phase != 1) {
            ...
            if (IN_EXTENSION_GROUP(specs, edx + (edx < td->elements_count
