...
int AbandonRequest_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void AbandonRequest_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td)
{
    td->free_struct = asn_DEF_MessageID.free_struct;
    td->print_struct = asn_DEF_MessageID.print_struct;
    td->check_constraints = asn_DEF_MessageID.check_constraints;
...
void AbandonRequest_free(asn_TYPE_descriptor_t *td, void *struct_ptr,
                         int contents_only)
{
...
int AbandonRequest_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t AbandonRequest_decode_ber(asn_codec_ctx_t *opt_codec_ctx,
...
asn_enc_rval_t AbandonRequest_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t AbandonRequest_decode_xer(asn_codec_ctx_t *opt_codec_ctx,
                                         asn_TYPE_descriptor_t *td,
                                         void **structure,
...
asn_enc_rval_t AbandonRequest_encode_xer(asn_TYPE_descriptor_t *td,
...
static const ber_tlv_tag_t asn_DEF_AbandonRequest_tags_1[] = {
    (ASN_TAG_CLASS_APPLICATION | (16 << 2)),
    (ASN_TAG_CLASS_UNIVERSAL | (2 << 2))};
asn_TYPE_descriptor_t asn_DEF_AbandonRequest = {
    "AbandonRequest", "AbandonRequest", AbandonRequest_free,
    AbandonRequest_print, AbandonRequest_constraint, AbandonRequest_decode_ber,
    AbandonRequest_encode_der, AbandonRequest_decode_xer,
    AbandonRequest_encode_xer, 0,
    0, /* No PER support, use "-gen-PER" to enable */
    0, /* Use generic outmost tag fetcher */
    asn_DEF_AbandonRequest_tags_1,
    sizeof(asn_DEF_AbandonRequest_tags_1) /
            sizeof(asn_DEF_AbandonRequest_tags_1[0]) -
        1,                         /* 1 */
