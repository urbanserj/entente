...
static const ber_tlv_tag_t asn_DEF_IntermediateResponse_tags_1[] = {
    (ASN_TAG_CLASS_APPLICATION | (25 << 2)),
    (ASN_TAG_CLASS_UNIVERSAL | (16 << 2))};
static const asn_TYPE_tag2member_t asn_MAP_IntermediateResponse_tag2el_1[] = {
    {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0}, /* responseName */
    {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0}  /* responseValue */
};
static asn_SEQUENCE_specifics_t asn_SPC_IntermediateResponse_specs_1 = {
    ...
    asn_MAP_IntermediateResponse_tag2el_1, 2, /* Count of tags in the map */
    0, 0, 0, /* Optional elements (not needed) */
    1,       /* Start extensions */
    3        /* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_IntermediateResponse = {
    "IntermediateResponse", "IntermediateResponse", SEQUENCE_free,
    SEQUENCE_print, SEQUENCE_constraint, SEQUENCE_decode_ber,
    SEQUENCE_encode_der, SEQUENCE_decode_xer, SEQUENCE_encode_xer, 0,
    ...
    sizeof(asn_DEF_IntermediateResponse_tags_1) /
            sizeof(asn_DEF_IntermediateResponse_tags_1[0]) -
        1,                               /* 1 */
