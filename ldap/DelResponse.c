 ...
 */
static void DelResponse_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td)
{
...
void DelResponse_free(asn_TYPE_descriptor_t *td, void *struct_ptr,
                      int contents_only)
{
    DelResponse_1_inherit_TYPE_descriptor(td);
    td->free_struct(td, struct_ptr, contents_only);
}

int DelResponse_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t DelResponse_decode_ber(asn_codec_ctx_t *opt_codec_ctx,
...
asn_enc_rval_t DelResponse_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t DelResponse_decode_xer(asn_codec_ctx_t *opt_codec_ctx,
                                      asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t DelResponse_encode_xer(asn_TYPE_descriptor_t *td,
...
static const ber_tlv_tag_t asn_DEF_DelResponse_tags_1[] = {
    (ASN_TAG_CLASS_APPLICATION | (11 << 2)),
    (ASN_TAG_CLASS_UNIVERSAL | (16 << 2))};
asn_TYPE_descriptor_t asn_DEF_DelResponse = {
    "DelResponse", "DelResponse", DelResponse_free, DelResponse_print,
    DelResponse_constraint, DelResponse_decode_ber, DelResponse_encode_der,
    DelResponse_decode_xer, DelResponse_encode_xer, 0,
    0, /* No PER support, use "-gen-PER" to enable */
    0, /* Use generic outmost tag fetcher */
    asn_DEF_DelResponse_tags_1,
    sizeof(asn_DEF_DelResponse_tags_1) / sizeof(asn_DEF_DelResponse_tags_1[0]) -
        1,                      /* 1 */
    asn_DEF_DelResponse_tags_1, /* Same as above */
    sizeof(asn_DEF_DelResponse_tags_1) /
        sizeof(asn_DEF_DelResponse_tags_1[0]), /* 2 */
