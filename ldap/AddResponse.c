...
int AddResponse_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void AddResponse_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td)
{
...
void AddResponse_free(asn_TYPE_descriptor_t *td, void *struct_ptr,
                      int contents_only)
{
...
int AddResponse_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t AddResponse_decode_ber(asn_codec_ctx_t *opt_codec_ctx,
...
asn_enc_rval_t AddResponse_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t AddResponse_decode_xer(asn_codec_ctx_t *opt_codec_ctx,
                                      asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t AddResponse_encode_xer(asn_TYPE_descriptor_t *td,
...
static const ber_tlv_tag_t asn_DEF_AddResponse_tags_1[] = {
    (ASN_TAG_CLASS_APPLICATION | (9 << 2)),
    (ASN_TAG_CLASS_UNIVERSAL | (16 << 2))};
asn_TYPE_descriptor_t asn_DEF_AddResponse = {
    "AddResponse", "AddResponse", AddResponse_free, AddResponse_print,
    AddResponse_constraint, AddResponse_decode_ber, AddResponse_encode_der,
    AddResponse_decode_xer, AddResponse_encode_xer, 0,
    0, /* No PER support, use "-gen-PER" to enable */
    0, /* Use generic outmost tag fetcher */
    asn_DEF_AddResponse_tags_1,
    sizeof(asn_DEF_AddResponse_tags_1) / sizeof(asn_DEF_AddResponse_tags_1[0]) -
        1,                      /* 1 */
