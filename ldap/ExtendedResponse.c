...
static asn_TYPE_member_t asn_MBR_ExtendedResponse_1[] = {
    ...
    {ATF_NOFLAGS, 0, offsetof(struct ExtendedResponse, matchedDN),
     ...
     0, /* PER is not compiled, use -gen-PER */
     0, "matchedDN"},
    {ATF_NOFLAGS, 0, offsetof(struct ExtendedResponse, diagnosticMessage),
    ...
    {ATF_POINTER, 2, offsetof(struct ExtendedResponse, responseName),
     ...
     &asn_DEF_LDAPOID, 0, /* Defer constraints checking to the member type */
     0,                   /* PER is not compiled, use -gen-PER */
     0, "responseName"},
    {ATF_POINTER, 1, offsetof(struct ExtendedResponse, responseValue),
...
static const ber_tlv_tag_t asn_DEF_ExtendedResponse_tags_1[] = {
    (ASN_TAG_CLASS_APPLICATION | (24 << 2)),
    (ASN_TAG_CLASS_UNIVERSAL | (16 << 2))};
static const asn_TYPE_tag2member_t asn_MAP_ExtendedResponse_tag2el_1[] = {
    ...
    {(ASN_TAG_CLASS_CONTEXT | (10 << 2)), 4, 0, 0},   /* responseName */
    {(ASN_TAG_CLASS_CONTEXT | (11 << 2)), 5, 0, 0}    /* responseValue */
};
static asn_SEQUENCE_specifics_t asn_SPC_ExtendedResponse_specs_1 = {
    ...
    asn_MAP_ExtendedResponse_tag2el_1, 6, /* Count of tags in the map */
    0, 0, 0,                              /* Optional elements (not needed) */
    5,                                    /* Start extensions */
    7                                     /* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_ExtendedResponse = {
    "ExtendedResponse", "ExtendedResponse", SEQUENCE_free, SEQUENCE_print,
    ...
    sizeof(asn_DEF_ExtendedResponse_tags_1) /
            sizeof(asn_DEF_ExtendedResponse_tags_1[0]) -
        1,                           /* 1 */
