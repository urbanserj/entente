...
static const ber_tlv_tag_t asn_DEF_ExtendedRequest_tags_1[] = {
    (ASN_TAG_CLASS_APPLICATION | (23 << 2)),
    (ASN_TAG_CLASS_UNIVERSAL | (16 << 2))};
static const asn_TYPE_tag2member_t asn_MAP_ExtendedRequest_tag2el_1[] = {
    {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0}, /* requestName */
    {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0}  /* requestValue */
};
static asn_SEQUENCE_specifics_t asn_SPC_ExtendedRequest_specs_1 = {
    sizeof(struct ExtendedRequest), offsetof(struct ExtendedRequest, _asn_ctx),
    asn_MAP_ExtendedRequest_tag2el_1, 2, /* Count of tags in the map */
    0, 0, 0,                             /* Optional elements (not needed) */
    1,                                   /* Start extensions */
    3                                    /* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_ExtendedRequest = {
    "ExtendedRequest", "ExtendedRequest", SEQUENCE_free, SEQUENCE_print,
    ...
    sizeof(asn_DEF_ExtendedRequest_tags_1) /
            sizeof(asn_DEF_ExtendedRequest_tags_1[0]) -
        1,                          /* 1 */
